...
JS;
   ...
   */
  protected function assertEmptyWithJs($field_name) {
   ...
   *   The expected value.
   */
  protected function assertEqualsWithJs($field_name, $expected) {
    $javascript = "(function (){ return jQuery('input[name=\"" . $field_name . "\"]').val(); })()";
    $field_value = $this->getSession()->evaluateScript($javascript);
   ...
   */
  protected function getLinkAttributeFromEditor($attribute) {
